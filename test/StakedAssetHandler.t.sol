...
contract MockProtocolHandler {
    ...
    function setStakingPosition(
        address safe,
        StakedAssetHandler.StakingPosition memory position
    ) external {
        positions[safe] = position;
    }
    
    function getStakingPosition(address safe, bytes calldata data) 
        external view returns (StakedAssetHandler.StakingPosition memory) 
    {
    ...
    function claimRewards(address safe, bytes calldata data) 
...
contract StakedAssetHandlerTest is Test {
    ...
    event StakingPositionDetected(
        ...
        StakedAssetHandler.ProtocolType protocolType,
        uint256 amount
    );
    ...
    function test_DetectStakingPositions() public {
        ...
        StakedAssetHandler.StakingPosition[] memory positions = 
            stakedAssetHandler.getStakingPositions(safe, protocol);
